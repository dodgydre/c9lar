...
},{"./fullcalendar.js":4,"./moment.min.js":5,"jquery":1}],4:[function(require,module,exports){
'use strict';var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol?"symbol":typeof obj;}; /*!
 * FullCalendar v2.6.1
 * Docs & License: http://fullcalendar.io/
 * (c) 2015 Adam Shaw
 */(function(factory){if(typeof define==='function'&&define.amd){define(['jquery','moment'],factory);}else if((typeof exports==='undefined'?'undefined':_typeof(exports))==='object'){ // Node/CommonJS
...
if(seg.bottom-seg.top<30){seg.el.addClass('fc-short');}}}, // ANDREAS: Set width to 30%
...
forwardCoord=Math.min(1,backwardCoord+(forwardCoord-backwardCoord)*2);}if(this.isRTL){left=1-forwardCoord;right=backwardCoord;}else {left=backwardCoord;right=1-forwardCoord;} // ANDREAS Set the width based on seg.level (1, 2, 3).
props.zIndex=seg.level+1; // convert from 0-base to 1-based
if(props.zIndex==1){props.left='0%';props.width='33.33%'; //props.right = '64%';
}else if(props.zIndex==2){props.left='33.33%';props.width='33.33%'; //props.right = '32%';
}else if(props.zIndex==3){props.left='66.66%';props.width='33.33%'; //props.right = '4%';
} //if (event.overlap)
//props.left = left * 100 + '%';
...
!function (a, b) {
  ...
  function a() {
    ...
    var c, d, e;if (m(b._isAMomentObject) || (a._isAMomentObject = b._isAMomentObject), m(b._i) || (a._i = b._i), m(b._f) || (a._f = b._f), m(b._l) || (a._l = b._l), m(b._strict) || (a._strict = b._strict), m(b._tzm) || (a._tzm = b._tzm), m(b._isUTC) || (a._isUTC = b._isUTC), m(b._offset) || (a._offset = b._offset), m(b._pf) || (a._pf = j(b)), m(b._locale) || (a._locale = b._locale), Sc.length > 0) for (c in Sc) {
      d = Sc[c], e = b[d], m(e) || (a[d] = e);
    }return a;
  }function o(b) {
    ...
    var b,
        c,
        d = a.match(Wc);for (b = 0, c = d.length; c > b; b++) {
    ...
    }var d = 5;for (Xc.lastIndex = 0; d >= 0 && Xc.test(a);) {
    ...
    var b,
        ...
        e,
        f = [];if (!a._d) {
      for (d = pa(a), a._w && null == a._a[td] && null == a._a[sd] && ra(a), a._dayOfYear && (e = oa(a._a[rd], d[rd]), a._dayOfYear > ha(e) && (j(a)._overflowDayOfYear = !0), c = ga(e, 0, a._dayOfYear), a._a[sd] = c.getUTCMonth(), a._a[td] = c.getUTCDate()), b = 0; 3 > b && null == a._a[b]; ++b) {
        a._a[b] = f[b] = d[b];
      }for (; 7 > b; b++) {
    ...
    if (b._f === a.ISO_8601) return void da(b);b._a = [], j(b).empty = !0;var c,
        ...
        h = "" + b._i,
        i = h.length,
        k = 0;for (e = N(b._f, b._locale).match(Wc) || [], c = 0; c < e.length; c++) {
      f = e[c], d = (h.match(P(f, b)) || [])[0], d && (g = h.substr(0, h.indexOf(d)), g.length > 0 && j(b).unusedInput.push(g), h = h.slice(h.indexOf(d) + d.length), k += d.length), Zc[f] ? (d ? j(b).empty = !1 : j(b).unusedTokens.push(f), T(f, d, b)) : b._strict && !d && j(b).unusedTokens.push(f);
    ...
    var b, c, d, e, f;if (0 === a._f.length) return j(a).invalidFormat = !0, void (a._d = new Date(NaN));for (e = 0; e < a._f.length; e++) {
      f = 0, b = n({}, a), null != a._useUTC && (b._useUTC = a._useUTC), b._f = a._f[e], sa(b), k(b) && (f += j(b).charsLeftOver, f += 10 * j(b).unusedTokens.length, j(b).score = f, (null == d || d > f) && (d = f, c = b));
    }g(a, c || b);
  }function va(a) {
    if (!a._d) {
    ...
    }), qa(b)) : "object" == (typeof f === "undefined" ? "undefined" : _typeof(f)) ? va(b) : "number" == typeof f ? b._d = new Date(f) : a.createFromInputFallback(b);
